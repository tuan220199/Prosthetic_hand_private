...
class DataCollectionhWindow(PageWindow):
    ...
    def make_handleButton(self, button, *args):
        def handleButton():
            ...
            global OFFSET_RMS,FORWARD,fetchingData, file1, channels 
                
            if button == "caliberate":
...
def dataSendLoop(addData_callbackFunc):
    ...
    #time.sleep(3)
    global PEAK, PEAK_MULTIPLIER, BASELINE, OFFSET_RMS, BASELINE_MULTIPLIER,FORWARD, fetchingData
    while(fetchingData):
        #channels[i:i+50*8]
